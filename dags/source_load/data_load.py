...
def run_script():
   ...
   def load_data():
      titles_file = s3.get_object(Bucket='netflix-data-analytics-useast1', Key='raw_files/titles.csv')
      credits_file = s3.get_object(Bucket='netflix-data-analytics-useast1', Key='raw_files/credits.csv')
